...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/insights/website-checklist-tradespeople" },
};
...
export default function Page() {
  return (
    <BlogPost
      ...
      description="Plumbers, electricians, roofers, landscapers. The rules are the same and most trade websites get them wrong. This is the checklist we use."
      title="Website Checklist for Tradespeople and Local Service Businesses"
      ctaHeading="Need a better trade website?"
      ctaBody="We build proper websites for local service businesses. Fixed price, two to three weeks, all set up properly."
      ctaLink="/digital/chippenham-small-business-websites"
      ctaLabel="See our trade websites"
    >
      <Lead>
      ...
      <H2>Phone number in the header, clickable on mobile</H2>
      ...
      <H2>Your service area on the homepage</H2>
      ...
      <H2>Real photos of real work</H2>
      ...
      <H2>Reviews or testimonials, with names</H2>
      ...
      <H2>Clear list of what you do (and what you do not)</H2>
      ...
      <H2>Pricing indication, even if it is ranges</H2>
      ...
      <H2>Certifications and insurance visible</H2>
      ...
      <H2>Google Business Profile claimed and active</H2>
      ...
      <H2>Social proof from recent jobs</H2>
      ...
      <H2>A contact form that actually works</H2>
